  ...
  describe "eval" $ do
    ...
    context "-" $ do
        ...
        it "subtracts floats" $ do
            eval "-" [Integer 6, Real 3.0] `shouldBe` [Real 3.0]
    ...
    context "/" $ do
        ...
        it "subtracts floats" $ do
            eval "/" [Integer 6, Real 3.0] `shouldBe` [Real 2.0]
            eval "/" [Real 3.0, Integer 3] `shouldBe` [Real 1.0]
            eval "/" [Real 4.0, Real 3.0] `shouldBe` [Real (4/3)]
    ...
    context "^" $ do
        it "powers integers" $ do
            eval "^" [Integer 5, Integer 3] `shouldBe` [Integer 125]
        
        it "powers floats" $ do
            eval "^" [Integer 2, Real 3.0] `shouldBe` [Real 8.0]
